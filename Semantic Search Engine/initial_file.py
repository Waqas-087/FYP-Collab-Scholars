...
def load_word_embeddings():
    ...
    try:
        f = open(r'E:\Work\Bahria University\FYP\Intelligent_Document_Finder-master\DataBase/glove.6B.100d.txt', encoding="utf-8")
...
def trained_tagger():
    ...
    if os.path.exists(os.path.join(os.getcwd(), r"E:\Work\Bahria University\FYP\Intelligent_Document_Finder-master\DataBase/trained_tagger.pkl")):
    ...
    pickle.dump(trigram_tagger, open(r'E:\Work\Bahria University\FYP\Intelligent_Document_Finder-master\DataBase/trained_tagger.pkl', 'wb'))
