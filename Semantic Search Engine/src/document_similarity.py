...
def execute_training_of_lda(corpus):
    ...
    pickle.dump(dictionary, open(r'E:\Work\Bahria University\FYP\Intelligent_Document_Finder-master\LdaModel/dictionary.pkl', "wb"))
    pickle.dump(doc_topic_dist, open(r'E:\Work\Bahria University\FYP\Intelligent_Document_Finder-master\LdaModel/doc_topic_distribution.pkl', "wb"))
    lda.save(r'E:\Work\Bahria University\FYP\Intelligent_Document_Finder-master\LdaModel/model')
...
def get_similar_documents(doc_corpus):
    dictionary = pickle.load(open(r"E:\Work\Bahria University\FYP\Intelligent_Document_Finder-master\LdaModel/dictionary.pkl", "rb"))
    doc_topic_dist = pickle.load(open(r"E:\Work\Bahria University\FYP\Intelligent_Document_Finder-master\LdaModel/doc_topic_distribution.pkl", "rb"))
    lda = LdaModel.load(r"E:\Work\Bahria University\FYP\Intelligent_Document_Finder-master\LdaModel/model")
